...
export type NotificationType = 'REGISTRATION_CONFIRMATION' | 'REMINDER' | 'CANCELLATION' | 'EMPLOYEE_REGISTERED_PARTICIPANT' | 'EVENT_CAPACITY_WARNING' | 'EVENT_FULL_ALERT' | 'EVENT_UPDATE' | 'DONATION_CONFIRMATION';
