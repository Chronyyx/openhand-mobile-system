...
class RegistrationServiceImplTest {
        ...
        @Mock
        private com.mana.openhand_backend.notifications.dataaccesslayer.NotificationRepository notificationRepository;
        ...
        void setUp() {
                ...
                lenient()
                                .when(eventCompletionService.ensureCompletedIfEnded(any(Event.class),
        ...
        void registerForEventWithFamily_withMultipleFamilyMembers_shouldCreateGroupAndUpdateCapacity() {
                ...
                // Act
                GroupRegistrationResponseModel result = registrationService.registerForEventWithFamily(1L, 1L,
                                familyMembers);
        ...
        void getUserRegistrationHistory_filtersAndSortsByCategory() {
                ...
                Registration activeReg = new Registration(testUser, activeEvent, RegistrationStatus.CONFIRMED,
                                now.minusDays(1));
                Registration pastReg1 = new Registration(testUser, pastEvent1, RegistrationStatus.CONFIRMED,
                                now.minusDays(6));
                Registration pastReg2 = new Registration(testUser, pastEvent2, RegistrationStatus.CONFIRMED,
                                now.minusDays(3));

                when(registrationRepository.findByUserIdWithEvent(1L))
                                .thenReturn(List.of(pastReg1, activeReg, pastReg2));

                List<com.mana.openhand_backend.registrations.domainclientlayer.RegistrationHistoryResponseModel> result = registrationService
                                .getUserRegistrationHistory(1L,
                                                com.mana.openhand_backend.registrations.domainclientlayer.RegistrationHistoryFilter.ALL);

                assertEquals(3, result.size());
                assertEquals(com.mana.openhand_backend.registrations.domainclientlayer.RegistrationTimeCategory.ACTIVE,
                                result.get(0).getTimeCategory());
        ...
        void getUserRegistrationHistory_whenFilterActive_returnsOnlyActive() {
                ...
                Registration activeReg = new Registration(testUser, activeEvent, RegistrationStatus.CONFIRMED,
                                now.minusDays(1));
                Registration pastReg = new Registration(testUser, pastEvent, RegistrationStatus.CONFIRMED,
                                now.minusDays(3));
                ...
                List<com.mana.openhand_backend.registrations.domainclientlayer.RegistrationHistoryResponseModel> result = registrationService
                                .getUserRegistrationHistory(1L,
                                                com.mana.openhand_backend.registrations.domainclientlayer.RegistrationHistoryFilter.ACTIVE);
        ...
        void getUserRegistrationHistory_includesGroupParticipantsWhenAvailable() {
                ...
                Registration primary = new Registration(testUser, event, RegistrationStatus.CONFIRMED,
                                now.minusDays(1));
                primary.setRegistrationGroupId("group-1");
        ...
        @Test
        void registerForEvent_shouldTriggerCapacityNotification_whenEventBecomesFull() {
                // Arrange
                ...
                // Assert
                assertEquals(EventStatus.FULL, localEvent.getStatus());
        ...
        @Test
        void registerForEvent_shouldTriggerCapacityNotification_whenEventBecomesNearlyFull() {
                // Arrange
                Event localEvent = new Event(
                                "Test Event",
                                "Test Description",
