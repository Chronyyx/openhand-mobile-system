...
class UserDetailsImplTest {
    ...
    void equals_comparesByIdOnly() {
        UserDetailsImpl d1 =
                new UserDetailsImpl(1L, "a@example.com", "pwd", true, Collections.emptyList());
        UserDetailsImpl d2 =
                new UserDetailsImpl(1L, "b@example.com", "pwd2", false, Collections.emptyList());
        UserDetailsImpl d3 =
                new UserDetailsImpl(2L, "a@example.com", "pwd", true, Collections.emptyList());
    ...
    void accountAndCredentialsStatusFlags() {
        UserDetailsImpl details =
                new UserDetailsImpl(1L, "user@example.com", "pwd", true, Collections.emptyList());
